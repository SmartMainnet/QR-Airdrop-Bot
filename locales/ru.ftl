...
airdrop =
    ...
    .info =
        ...
        Хочешь получить еще больше <b>$QR</b>? 🦸‍♂️ Просто пригласи друга! Отправляй приглашение или ссылку — как только друг запустит бота и выполнит все условия, ты и твой друг получите по <b>{ $amount } $QR</b>. Бонус придёт <b>за каждого друга!</b>
